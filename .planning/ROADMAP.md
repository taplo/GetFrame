...
**Mode**: mvp
**Depends on**: Phase 2
**Requirements**: RULE-02, RULE-03, RULE-06, API-03, STREAM-07, STREAM-08
**Success Criteria** (what must be TRUE):
  ...
  5. Failed streams auto-reconnect with exponential backoff; extended failures trigger graceful cleanup
**Plans**: 03-01 (ready)
...
Plans:
- [x] 05-01-PLAN.md — Config extensions, Avro Schema Registry, at-least-once delivery, configurable topics, retention policy
...
Plans:
- [ ] 06-01-PLAN.md — Task API implementation (StreamManager refactor, TaskManager, 8 REST endpoints)
- [ ] 06-02-PLAN.md — OpenAPI/Swagger documentation (utoipa annotations, Swagger UI)
...
|-------|----------------|--------|-----------|
| 1. Core Pipeline | 1/1 | Done | 2026-05-24 |
| 2. Multi-Stream Management | 1/1 | Done | 2026-05-24 |
